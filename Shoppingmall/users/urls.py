...
urlpatterns = [
    ...
    path('category/<str:category>/<str:product>/order_form/<str:quantity>', views.only_order_form, name='only_order_form'),# 상품상세에서 바로 구매하기 -->그상품만 결제
    path('order_form/<str:product>/<str:quantity>',views.order_form, name='order_form'),#장바구니에서 구매하기로넘어가기 (cartlist조회를 해서 선택한것들 구매)
