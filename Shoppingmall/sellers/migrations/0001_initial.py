# Generated by Django 3.0.8 on 2020-07-23 03:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.CharField(max_length=1000, null=True, verbose_name='댓글')),
                ('view', models.IntegerField(default=0, null=True, verbose_name='조회수')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sellers.Category', verbose_name='카테고리')),
            ],
        ),
    ]
